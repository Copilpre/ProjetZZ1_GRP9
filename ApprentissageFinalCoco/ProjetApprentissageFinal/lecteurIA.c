...
void sauvTable(float Qtable[21][21][21][7][5]){
    int i,j,k,a,l;
...
int main(){
    ...
    for(CompteurIterationProgramme = 0 ; CompteurIterationProgramme < 5 ; CompteurIterationProgramme ++){ 
    //BOUCLE DE REMPLISSAGE DE LA PILE
    program_on = 1;
    barreD = barreM = barreJ = 19;
    ligne.x=barreM;
    ligne.y=barreJ;
    ligne.z=barreD;
    ligne.position= 0;
